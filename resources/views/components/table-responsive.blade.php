<div class="w-full">
    <div class="mb-8 flex items-center justify-between gap-8">
        <div>
            <h6 class="font-sans antialiased font-bold text-base md:text-lg lg:text-xl text-current">Lista de Cursos
            </h6>
            <p class="font-sans antialiased text-base text-current mt-1">Los cursos que has creado están aquí</p>
        </div>
    ...
    <div class="flex flex-col items-center justify-between gap-4 md:flex-row">
        ...
        <div class="w-full grid grid-cols-1 gap-4 md:grid-cols-2 md:items-center">
            ...
            <!-- Columna 2: Botón alineado a la derecha en escritorio -->
            <div class="justify-self-start md:justify-self-end">
                <a href="{{ route('instructor.courses.create') }}"
                    class="w-full md:w-auto inline-flex items-center justify-center border align-middle select-none font-sans font-medium text-center duration-300 ease-in disabled:opacity-50 disabled:shadow-none disabled:cursor-not-allowed focus:shadow-none text-md py-1.5 px-6 shadow-sm hover:shadow-md bg-stone-800 hover:bg-stone-700 relative bg-gradient-to-b from-stone-700 to-stone-800 border-stone-900 text-stone-50 rounded-lg hover:bg-gradient-to-b hover:from-stone-800 hover:to-stone-800 hover:border-stone-900 after:absolute after:inset-0 after:rounded-[inherit] after:box-shadow after:shadow-[inset_0_1px_0px_rgba(255,255,255,0.25),inset_0_-2px_0px_rgba(0,0,0,0.35)] after:pointer-events-none transition antialiased">
                    Nuevo Curso
                </a>
            </div>
        </div>
