<div>
    <section>
        <h1 class="uppercase font-bold text-2xl border-b-2 mb-2 pb-2 border-gray-300">Metas del Curso</h1>
        @if (session('success'))
            <div role="alert"
                ...
                <div class="px-6 py-4 bg-gray-100">
                    @if ($goal->id == $item->id)
                        <form wire:submit.prevent="update" wire:key="update-{{ $item->id }}">
                            <div>
                                <input type="text" id="" wire:model.live="name" wire:keydown.escape="cancel"
                                    autofocus
