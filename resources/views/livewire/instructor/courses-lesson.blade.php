        ...
        <article class="bg-white shadow-lg rounded overflow-hidden mt-4" x-data="{ open: false }">
            <div class="px-6 py-4">
                @if ($lesson && $lesson->id == $item->id)
                    <form wire:submit.prevent="update">
                        <div class="flex items-center">
                            <label for="name" class="w-32 cursor-pointer">Nombre:</label>
                            <input id=""
                ...
                @else
                    ...
                    <div class="border-t-2 my-2" x-show="open">
                        ...
                        <div class="my-2">
                            ...
                            <button wire:click="destroy({{ $item }})"
                                wire:confirm="¿Estás seguro de eliminar esta lección? La descripción y la imagen también se eliminarán!!"
